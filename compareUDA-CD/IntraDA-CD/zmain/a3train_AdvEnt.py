...
if __name__ == '__main__':
    ...
    saveLast=False
    name = opt.dset + 'CDDA/' + opt.model_type + 'AdvEntall'
    opt.LChannel=True
    ...
    saveroot = '/data/project_frb/DA/DACDCompare/CDDA/IntraDA-CD/zmain/log/CD_DA_buildingCDDA/FCSiamDiffAdvEntall/20230926-10_30_GZ_CDPatch/'#
    save_path = saveroot + '/savemodel/_6_acc-0.9531_chgAcc-0.0277_unchgAcc-0.9984.pth'#
    ...
    opt.hardspilt='/data/project_frb/DA/DACDCompare/CDDA/IntraDA-CD/zmain/G-L/hard_split.txt'
