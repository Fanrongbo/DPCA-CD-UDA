...
if __name__ == '__main__':
    ...
    saveroot = './log/CD_DA_buildingCDBase/FCSiamDiff/20231214-22_47_L-GZ-pretrain/'#
    save_path = saveroot + '/savemodel/_5_acc-0.7193_chgAcc-0.3350_unchgAcc-0.7421.pth'#
    ...
    opt.hardspilt='/data/project_frb/DA/DACDCompare/EasytoHardAdvent/zmain/G-L/hard_split.txt'
