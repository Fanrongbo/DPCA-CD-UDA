...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--easyspilt', type=str, default=None, help="easyspiltPath")
        self.parser.add_argument('--hardspilt', type=str, default=None, help="easyspiltPath")
