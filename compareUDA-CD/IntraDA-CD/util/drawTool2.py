...
def MakeRecordFloder(name, time_now,opt,filename_main,pretrain,saveroot):
    ...
    if pretrain:
        ...
        for i in cfg.TRAINLOG.EXCEL_LOGSheet:
            ...
            ws.append(
                ['type', 'n_epochs', 'lossAvg', 'CES_lossAvg','DGAN_LossAvg', 'CET_lossAvg', 'Acc', 'nochange_acc', 'change_acc', 'recall'
                , 'fm1', 'IOU', 'prec', 'TN', 'TP', 'FN', 'FP','EntropyT','EntropyunchgT','EntropychgT','EntropyT2','accT','unchgaccT','chgaccT','mf1T'])
