...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--t', type=int, default=1, help="target")
        self.parser.add_argument('--easyspilt', type=str, default='/data/project_frb/DA/DACDCompare/EasytoHardAdvent/zmain/G-L/easy_split.txt', help="easyspiltPath")
        self.parser.add_argument('--hardspilt', type=str, default='/data/project_frb/DA/DACDCompare/EasytoHardAdvent/zmain/G-L/hard_split.txt', help="easyspiltPath")
