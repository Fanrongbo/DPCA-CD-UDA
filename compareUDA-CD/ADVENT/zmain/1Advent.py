...
from model.Siamese_diff import FCSiamDiffMaskAttention,FCSiamDiffMaskAttentionCenter,FCSiamDiff
...
if __name__ == '__main__':
    ...
    opt.model_type = 'Advent'
    cfg.DA.NUM_DOMAINS_BN = 1
    ttest = False
    saveLast = False
    name = opt.dset + 'CDPretrain2/' + opt.model_type + 'advent'
    ...
    for epoch in range(start_epoch, opt.num_epochs + opt.num_decay_epochs + 1):
        ...
        for i in tbar:
            ...
            cd_predT, defeat3T, defeatTDA = net.forward(TT1, TT2)
            ...
            lossT = loss_DT.item() + loss_DS.item() + TCELoss.item() + SCELoss.item()
        ...
        if saveLast:
            if epoch == opt.num_epochs:
                ...
                tool.save_ckptGANCenter(network=[net,model_D1,model_D1],Center=[None,None,None], optimizer=optimizer, save_str=save_str)
            ...
            tool.save_ckptGANCenter(network=[net, model_D1, model_D1], Center=[None,None,None], optimizer=optimizer,
                                    save_str=save_str)
