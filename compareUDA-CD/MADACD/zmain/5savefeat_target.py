...
if __name__ == '__main__':
    ...
    # saveroot=None//
    saveroot = '/data/project_frb/DA/DACDCompare/MADACD/zmain/log/CD_DA_buildingCDDA/FCSiamDiffstage1/20230925-11_34_GZ_CDPatch/'
    save_path = saveroot + '/savemodel/_6_acc-0.9275_chgAcc-0.2283_unchgAcc-0.9617.pth'
    ...
    t_loader = t_loaderDict[cfg.TRAINLOG.DATA_NAMES[cfg.DA.T]]
    t_data = t_loader.load_data()
    t_data_len = len(t_data)
    ...
    for i in tbar:
        with torch.no_grad():
            ...
            # if i>10:
            #    break
    torch.save(full_dataset_objective_vectors, './output/G-L/Target_objective_vectors.pkl')
